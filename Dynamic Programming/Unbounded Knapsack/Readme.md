We are given <b><i>infinite</i></b> items with a weight and a value. We have to put these items in a bag of capacity C such that the value in the bag is maximum and the capacity is not voilated.
